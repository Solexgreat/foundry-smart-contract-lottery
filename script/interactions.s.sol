...
contract AddConsumer is Script {
    ...
    function addConsumer(
        address contractToAddTVrf,
        address vrfCoordinator,
        uint256 subId
    ) public {
        console.log("Adding consumer contract:", contractToAddTVrf);
        conosle.log("To vrfCoordinator:", vrfCoordinator);
        console.log("To ChainId:", block.chainId);
        vm.startBroadcast();
        VRFCoordinatorV2_5Mock(vrfCoordinator).addConsumer(subId, contractToAddTVrf)
        vm.stopBroadcast()
